...
import type { Department, Location, ManagerLocation, Profile } from "@/lib/types";
  ...
  return (
    <div>
      ...
      <p className="mb-8 text-stone-600">
        ...
        they only see hires at their stores. Assign each employee a
        department so they see the right training days.
      </p>
      <TeamManager
